...
String getHTML() {
  ...
  <html>
  <head>
    <title>Coder Games - SignalWire Maker Challenge - 2025 ESP32 SMS LED Toggle Monitor</title>
  ...
  <body>
    <div class="container-fluid">
      <h1 class="text-center text-white mb-4">Coder Games - SignalWire Maker Challenge 2025 - ESP32 SMS LED Toggle Monitor</h1>
      <div class="row">
