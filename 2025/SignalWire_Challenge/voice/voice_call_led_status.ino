...
String getHTML() {
  ...
  <html>
  <head>
    <title>Coder Games - SignalWire Challenge 2025 - ESP32 Voice Call LED Status Monitor</title>
  ...
  <body>
    <div class="container-fluid">
      <h1 class="text-center text-white mb-4">Coder Games - SignalWire Challenge 2025 - ESP32 Voice Call LED Status Monitor</h1>
      <div class="row">
